...
use \ArrayAccess;
/**
 * ApplicationReceivable Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplicationReceivable implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'created_at' => 'string',
        'refunds' => '\SquareConnect\Model\ApplicationReceivableRefund[]'
    );
    ...
    /**
      * $id The application receivable's unique ID, issued by Square payments servers.
      * @var string
      */
    protected $id;
    /**
      * $transaction_id The ID of the transaction that the application receivable was applied to.
      * @var string
      */
    ...
    /**
      * $created_at The time when the application receivable was created, in RFC 3339 format.
      * @var string
      */
    protected $created_at;
    /**
      * $refunds Any refunds of the receivable that have been applied.
      * @var \SquareConnect\Model\ApplicationReceivableRefund[]
      */
    protected $refunds;
    ...
    /**
     * Sets id
     * @param string $id The application receivable's unique ID, issued by Square payments servers.
     * @return $this
     */
    ...
    /**
     * Sets transaction_id
     * @param string $transaction_id The ID of the transaction that the application receivable was applied to.
     * @return $this
     */
    ...
    /**
     * Sets created_at
     * @param string $created_at The time when the application receivable was created, in RFC 3339 format.
     * @return $this
     */
    ...
    /**
     * Gets refunds
     * @return \SquareConnect\Model\ApplicationReceivableRefund[]
     */
    ...
    /**
     * Sets refunds
     * @param \SquareConnect\Model\ApplicationReceivableRefund[] $refunds Any refunds of the receivable that have been applied.
     * @return $this
     */
